...
import com.giangbb.microservices.cqrs.cmd.domain.EventStoreRepository;
import com.giangbb.microservices.cqrs.core.events.BaseEvent;
import com.giangbb.microservices.cqrs.core.events.EventModel;
import com.giangbb.microservices.cqrs.core.exceptions.AggregateNotFoundException;
import com.giangbb.microservices.cqrs.core.exceptions.ConcurrencyException;
...
public class AccountEventStore implements EventStore {
    ...
    public void saveEvents(String aggregateId, Iterable<BaseEvent> events, int expectedVersion) {
        //retrive all event for given aggregate
